...
import { hotelInfo, navLinks } from "@/data/content";
...
export default function Footer() {
    ...
    return (
        <footer className="relative bg-ocean-deep text-white overflow-hidden">
            {/* Decorative Wave */}
            ...
            <div className="container mx-auto px-4 lg:px-8 pt-20 pb-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <p className="text-white/70 mb-6 leading-relaxed">
                                Experience tropical luxury on the pristine shores of Southern Sri Lanka.
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map((link) => (
                                <li key={link.name}>
                                    <a
                                        href={link.href}
                                        className="text-white/70 hover:text-sunset transition-colors"
                                    >
                                        {link.name}
                                    </a>
                                </li>
                ...
                <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-white/60 text-sm">
                        © {currentYear} Jaya Hotel. All rights reserved.
                    </p>
                    <p className="text-white/60 text-sm">
